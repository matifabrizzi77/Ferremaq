                    ...
                    <form class="form-horizontal" action="servicioregistrado.php" method="post">
                        <div class="well">
                            <div class="form-group" action="nuevoservicio.php" method="post">                              	
                                ...
                                <a href="create.php" class="btn btn-danger">Nuevo</a>
                            </div>
                            <div class="form-group" action="nuevoservicio.php" method="post">
                                ...
                                <div class="col-xs-5">		
                                    ...
                                    ?>
                                    <div>
                                        <select name="trabajo" class="form-control" id="sel1">
                                            <?php
                                            echo $opciones;
                                            ?>
                                        </select>  
                            ...
                            <div class="form-group" action="nuevoservicio.php" method="post">
                                ...
                                <div class="col-xs-5">		
                                    ...
                                    ?>
                                    <div>
                                        <select name="marca" class="form-control" id="sel1">
                                            <?php
                                            echo $opciones;
                                            ?>
                                        </select>  
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-5">		
                                    ...
                                    ?>
                                    <div>
                                        <select name="equipo" class="form-control" id="sel1">
                                            <?php
                                            echo $opciones;
                                            ?>
                                        </select>  
                            ...
                            <!--                            <div class="form-group" action="nuevoservicio.php" method="post">
                                                            ...
                                                            <div class="col-xs-5">
                                                                <div class="input_container">
                                                                    <input type="text" onkeyup="completar()" name="modelo" class="form-control" id="codmodelo" placeholder="Nombre modelo">
                                                                    <ul id="modelo_list_id"></ul>
                                                                </div>	
                                                            </div>
                                                        </div>-->                    
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-5">		
                                    ...
                                    ?>
                                    <div>
                                        <select name="modelos" class="form-control" id="sel1">
                                            <?php
                                            echo $opciones;
                                            ?>
                                        </select>  
                            ...
                            <div class="form-group">
                                ...
                                <a href="create.php" class="btn btn-danger">Agregar</a>
                                <div class="col-xs-5">		
                                    <?php
                                    ...
                                    ?>
                                    <div>
                                        <select name="accesorios" class="form-control" id="sel1">
                                            <?php
                                            echo $opciones;
                                            ?>
                                        </select>  
                            ...
                            <div class="form-group" action="nuevoservicio.php" method="post">
                                ...
                                <div class="col-xs-5">		
                                    ...
                                    ?>
                                    <div>
                                        <select name="tecnico" class="form-control" id="sel1">
                                            <?php
                                            echo $opciones;
                                            ?>
                                        </select>  
